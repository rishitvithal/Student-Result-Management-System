...
if($num1 > 0)
{
    ...
    <tr>
        ...
        <td colspan="2"><b><?php echo $totalc; ?></b>  out of  <b><?php echo ($outof = ($cnt - 1)*100);?></b></td>
    </tr>
    <tr>
        <th scope="row" colspan="2" >SGPA : </th>
        <td colspan="2"><b><?php echo number_format(($totalc * (100) / $outof) / 9.5, 2);?></b></td>
    </tr>
    <tr>
    <th scope="row" colspan="2" >Download Result : </th>
        <td colspan="2"><button style="background-color:white; font-size:18px" onclick="printDiv('d1','Title')">Download</button></td>
    </tr>
    <?php 
} else{?>
<div class="rnd">
